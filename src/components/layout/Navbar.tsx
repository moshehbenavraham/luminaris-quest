      ...
      <div className="container flex h-16 items-center">
        <div className="mr-4 flex">
          <Link to="/" className="group mr-6 flex items-center space-x-3">
            <div className="animate-glow from-primary to-accent rounded-xl bg-gradient-to-br p-2">
              <Sparkles className="h-6 w-6 text-white" />
            </div>
            <span className="from-primary to-accent font-heading bg-gradient-to-r bg-clip-text text-xl font-bold text-transparent">
              Luminari&apos;s Quest
            </span>
          </Link>
          <nav className="hidden items-center space-x-2 text-sm font-medium md:flex">
            <Link
              to="/adventure"
              className="nav-link hover:bg-primary/10 hover:text-primary rounded-full px-4 py-2 transition-all duration-200"
            >
              Adventure
            </Link>
            <Link
