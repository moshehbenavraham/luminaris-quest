/* eslint-disable react-refresh/only-export-components -- Sidebar context exports needed by shadcn/ui */
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Random width between 50 to 90% (React 19 purity compliance - use useState initializer)
