/* eslint-disable @typescript-eslint/no-explicit-any -- Database diagnostic utilities require flexible types for RPC responses and error handling */
/*
 * MIT License
...
export async function runAllDiagnostics(): Promise<{
  ...
  return {
    overallSuccess:
      databaseDiagnostics.success && journalSaveDiagnostics.success && authStatusCheck.success,
    databaseDiagnostics,
    journalSaveDiagnostics,
    authStatusCheck,
  };
