...
export const CombatReflectionModal: React.FC<CombatReflectionModalProps> = React.memo(function CombatReflectionModal({
  isOpen,
  onClose,
  'data-testid': testId
}) {
  ...
  const handleClose = useCallback(() => {
    ...
    if (reflectionData) {
      ...
      const lpDifference = reflectionData.endingResources.lp - reflectionData.startingResources.lp;
      const spDifference = reflectionData.endingResources.sp - reflectionData.startingResources.sp;
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-amber-600">
                      {reflectionData.lpGained > 0 ? `+${reflectionData.lpGained}` : reflectionData.lpGained}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium flex items-center gap-1">
                    ...
                    <span className="text-sm font-bold text-purple-600">
                      {reflectionData.spGained > 0 ? `+${reflectionData.spGained}` : reflectionData.spGained}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium flex items-center gap-1">
              ...
              {!reflectionData.victory && (
                <div className="p-3 bg-orange-50 border border-orange-200 rounded-lg">
                  <p className="text-sm text-orange-800">
                    <strong>Note:</strong> You&apos;ll need to retry this scene. 
                    You lost {Math.floor(gameStore.maxPlayerEnergy * 0.2)} energy points, 
                    but your health has been restored to continue your journey.
                  </p>
                </div>
              )}
